            ...
            <Container>
                <div style={{margin:"15px"}}>
                    ...
                    <Form>
                        ...
                        <Form.Control type="text" style={{border:"1px solid"}} onChange={(e) => {setName(e.target.value)}} id="Name"/>
                        <Form.Label><b>Mobile number or email</b></Form.Label>
                        <Form.Control type="text" style={{border:"1px solid"}} onChange={(e) => {setMobile(e.target.value)}} id="Mobile"/>
                        <Form.Label><b>Password</b></Form.Label>
                        <Form.Control type="password" style={{border:"1px solid"}} onChange={(e) => {setPassword(e.target.value)}} id="Pass"/>
                        <Form.Label><b>Re-enter password</b></Form.Label>
                        <Form.Control type="password" style={{border:"1px solid"}} onChange={(e) => {setRePass(e.target.value)}} id="rePass"/>
                    </Form>
                ...
                <div>
                    <p><b>Already have an account? <Link to={"/SignIn"} style={{textDecoration:"none"}}>Sign In</Link></b></p>
                </div>
            </Container>
        </div>
        </>
